      ...
      <section
         ...
         <motion.div
            ...
            <div className="w-fit break-words">
               <Link
                  href="mailto:malekzishan1110@gmail.com"
                  target="_blank"
                  rel="noreferrer"
            ...
            <Link href="document/MALEKZISHAN.pdf" target="_blank" rel="noreferrer" className="w-fit">
               <div className="btn w-fit bg-tertiary text-white px-7 py-2 rounded-md overflow-hidden relative cursor-pointer">
                  <div className="original bg-primary text-white px-7 py-2">Resume</div>
